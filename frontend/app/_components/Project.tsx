...
const Project = ({
    ...
    useEffect(() => {
        return () => {
            if (linkTlRef.current) {
                linkTlRef.current.kill();
                linkTlRef.current = null;
            }
        };
    }, []);
    ...
    const handleMouseEnter = () => {
        ...
        const arrowLine = svg.querySelector(
            '#arrow-line',
        ) as SVGPathElement | null;
        const arrowCurb = svg.querySelector(
            '#arrow-curb',
        ) as SVGPathElement | null;
