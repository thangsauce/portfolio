                ...
                <div className="grow flex w-auto px-4 md:px-4 lg:px-5">
                    <div className="flex gap-6 flex-col md:flex-row md:items-center md:gap-4 w-auto">
                        <div className="order-2">
                            <p className="text-primary mb-3 md:mb-0 md:mr-2 text-xs md:text-[11px] tracking-[0.14em] md:hidden [[data-theme='light']_&]:text-zinc-900">
                                SOCIAL
                            </p>
                                ...
                                {SOCIAL_MENU_LINKS.map((link) => (
                                    <li key={link.name}>
                                        {'internal' in link && link.internal ? (
                                            ...
                                            >
                                                {link.name === 'github' && (
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="text-foreground/75 transition-all duration-200 group-hover:text-white [[data-theme='light']_&]:text-zinc-800 [[data-theme='light']_&]:group-hover:text-zinc-700">
                        ...
                        <div className="order-1 md:hidden">
                            <p className="text-primary mb-3 [[data-theme='light']_&]:text-zinc-900">
                                MENU
                            </p>
                                ...
                                {MENU_LINKS.map((link) => (
                                    <li key={link.name}>
                                        <button
                                            ...
                                            className="nav-shake group text-base flex items-center gap-3 text-left hover:text-white transition-colors duration-200 [[data-theme='light']_&]:text-zinc-900 [[data-theme='light']_&]:hover:text-zinc-700"
                                        >
                                            <span
                                                className="size-4 flex items-center justify-center text-foreground/40 group-hover:text-white group-hover:translate-x-0.5 transition-all [[data-theme='light']_&]:text-zinc-600 [[data-theme='light']_&]:group-hover:text-zinc-700"
                                            >
                                                <svg
                                                    width="14"
                                                    height="14"
